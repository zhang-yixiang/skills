...
- **[improve-codebase-architecture](./improve-codebase-architecture/SKILL.md)** — Scan existing code for evidence-backed simplifications or deepening opportunities, with a read-only subtractive report or a visual survey and grilling loop.
...
- **[code-review](./code-review/SKILL.md)** — Two-axis review of the diff since a fixed point: **Standards** (repo rules plus smell and mechanism-growth baselines) and **Spec** (faithfulness to the originating issue/spec), run as parallel sub-agents.
